...
const Service = () => {
  return (
    <section className="pb-0 pt-20 dark:bg-dark lg:pb-[5px] lg:pt-[120px]">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              ...
              <p className="text-base text-gray-900 dark:text-dark-6">
        ...
        <div className="relative isolate -mx-4 flex flex-wrap">
            <div
            aria-hidden="true"
          ...
          <ServiceCard
            ...
            icon={ 
                <img src="/social.png" alt="Icon" width="120" height="120" />
          ...
          <ServiceCard
            title="Meta Ads"
            details="Drive results with targeted Meta Ads—designed to connect, engage, and convert your ideal audience effectively"
            icon={
                <img src="/targetz_Logo.png" alt="Icon" width="36" height="36" />
            //   <svg
            //     width="36"
            //     height="36"
            //     viewBox="0 0 36 36"
          ...
          <ServiceCard
            title="Google Ads"
            details="Reach the right audience at the right time with precision-targeted Google Ads that deliver measurable results."
            icon={
                <img src="/targetz_Logo.png" alt="Icon" width="36" height="36" />
            //   <svg
            //     width="36"
          ...
          <ServiceCard
            title="SEO"
            details="Boost your online visibility and drive organic traffic with tailored SEO strategies that rank your business higher."
            icon={
                <img src="/targetz_Logo.png" alt="Icon" width="36" height="36" />
            //   <svg
            //     width="36"
          ...
          <ServiceCard
            ...
            details="Accelerate your online sales with data-driven strategies, including managing your Flipkart, Amazon, Meesho, and other e-commerce platforms."
            icon={
                <img src="/targetz_Logo.png" alt="Icon" width="36" height="36" />
            //   <svg
            //     width="36"
          ...
          <ServiceCard
            ...
            details="Attract, engage, and convert quality leads with targeted strategies that drive business growth and maximize ROI."
            icon={
                <img src="/targetz_Logo.png" alt="Icon" width="36" height="36" />
            //   <svg
            //     width="36"
    ...
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-[20px] bg-white p-10 shadow-2 hover:shadow-lg dark:bg-dark-2 md:px-7 xl:px-10">
          ...
          <p className="text-gray-900 dark:text-dark-6">{details}</p>
        </div>
      </div>
    </>
  );
